...
import { searchDocs } from '$lib/utils/meilisearch'
...
const navLinks = [
  { href: '/docs/intro', label: 'Getting Started' },
			...
			<div class="flex items-center gap-3">
				<a href="/" class="flex items-center gap-3 group">
					...
					<div class="hidden sm:block">
						<span class="text-lg font-bold text-surface-900 dark:text-white">Rivet</span>
